const config = {
    ...
    sys:{
        ...
        sendMsgRetryNum:5,          //队列 向手机邮箱发送消息失败重试次数
    ...
    cacheKey:{
        ...
        Ongoing_Entrust:"Ongoing_Entrust_Exchange_Id_",
    ...
    SMS_Alicloud:{
        accessKeyId:'LTAI22bv7nKPG14U',
        secretAccessKey:'79ZjH7wWcpDb5NJtBpUhFAgnCdYOym'
    },
    SMS_Content_Code:{
        OTP:"SMS_10245011",
        OTP_CHINA:"SMS_10250007",
        OPT_CHINA_SIG:"AsiaEDXChina"
    }
};
