            ...
            try{
                ...
                if(reqEntrustRes.affectedRows && resEntrustRes.affectedRows && 
                    ...
                    if(reqEntrustStatus == 1){
                        ...
                        socket.emit('userEntrustList',{user_id:reqItem.user_id,coin_exchange_id:reqItem.coin_exchange_id});
                        ...
                        socket.emit('entrustList',{coin_exchange_id:reqItem.coin_exchange_id});
                        socket.emit('userEntrustList',{user_id:reqItem.user_id,coin_exchange_id:reqItem.coin_exchange_id});
                        socket.emit('historyEntrustList',{user_id:reqItem.user_id,coin_exchange_id:reqItem.coin_exchange_id});
                    }
                    if(resEntrustStatus == 1){
                        ...
                        socket.emit('userEntrustList',{user_id:resItem.user_id,coin_exchange_id:resItem.coin_exchange_id});
                        ...
                        socket.emit('entrustList',{coin_exchange_id:resItem.coin_exchange_id});
                        socket.emit('userEntrustList',{user_id:resItem.user_id,coin_exchange_id:resItem.coin_exchange_id});
                        socket.emit('historyEntrustList',{user_id:resItem.user_id,coin_exchange_id:resItem.coin_exchange_id});
                    }
                }else{
                    cnt.rollback();
                    return res;
